...
y2 = np.reshape(np.array(y.mbti1=='Ni'),(len(X2),1)).astype(float)
print X2.shape, y2.shape

import statsmodels.api as sm
import statsmodels.formula.api as smf
#logit = sm.Logit(y2, X2)
#logit = smf.GLM(y2,X2,family=sm.families.Binomial())
#logit.fit()
\end{minted}
...
Time:                        21:44:06   Log-Likelihood:                -217.59
...
X3 = X.fillna(0)
X3 = X3.apply(scale_function)
X3 = X3.fillna(0)
pca = KernelPCA().fit(X3)
\end{minted}
...
print get_we(pca.lambdas_)[:30]
\end{minted}

\begin{verbatim}
373
[ 1685.  1593.  1539.  1538.  1502.  1464.  1436.  1426.  1413.  1392.]
[ 0.01194723  0.01129146  0.01091106  0.01090361  0.01064785  0.01038328
  0.01018256  0.01011184  0.01001909  0.0098662   0.00953859  0.00940746
  0.00919753  0.00912069  0.00898153  0.00881529  0.00870736  0.00847525
  0.0083708   0.00820491  0.00816982  0.00812248  0.00807852  0.00797212
  0.00790487  0.00774531  0.00766712  0.00757242  0.00747882  0.0073608 ]
\end{verbatim}
